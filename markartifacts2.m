...
fprintf('\n%d channels marked as bad: ', sum(badchannels));
...
fprintf('%d trials marked as bad.\n\n', sum(EEG.reject.rejmanual));
...
badchannels = [find(chanvar > handles.chanvarthresh); find(chanvar < 0.5)];
...
set(handles.chanAxes,'XLim',[1 EEG.nbchan],'YLim',[0 handles.chanvarthresh*10],...
...
set(handles.trialAxes,'XLim',[1 EEG.trials],'YLim',[0 handles.trialvarthresh*10]);
